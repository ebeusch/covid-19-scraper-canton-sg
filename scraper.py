...
c.execute(
    ...
    [
        ...
        'Canton_SG',
        0,
        'https://www.sg.ch/news/sgch_allgemein/2020/03/zwei-personen-in-quarantaene---kein-bestaetigter-fall.html'
    ]
)
c.execute(
    '''
    ...
    [
        ...
        'Canton_SG',
        1,
        'https://www.sg.ch/news/sgch_allgemein/2020/03/erster-bestaetigter-corona-fall-im-kanton-.html',
    ]
)
c.execute(
    '''
    ...
    [
        ...
        'Canton_SG',
        2,
        'https://www.sg.ch/news/sgch_allgemein/2020/03/zweiter-bestaetigter-fall-einer-corona-patientin.html',
    ]
)
c.execute(
    '''
